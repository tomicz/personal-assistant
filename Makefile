...
# Targets and rules
output: $(BUILD_DIR)/main.o $(BUILD_DIR)/database.o $(BUILD_DIR)/parser.o $(BUILD_DIR)/user_interface.o $(BUILD_DIR)/dairy.o $(BUILD_DIR)/weight.o $(BUILD_DIR)/bmi_calculator.o $(BUILD_DIR)/goals_interface.o $(BUILD_DIR)/exercise_controller.o $(BUILD_DIR)/fitness_interface.o
	$(CXX) $(CXXFLAGS) $(BUILD_DIR)/main.o $(BUILD_DIR)/database.o $(BUILD_DIR)/parser.o $(BUILD_DIR)/user_interface.o $(BUILD_DIR)/dairy.o $(BUILD_DIR)/weight.o $(BUILD_DIR)/bmi_calculator.o $(BUILD_DIR)/goals_interface.o $(BUILD_DIR)/exercise_controller.o $(BUILD_DIR)/fitness_interface.o -o $(BUILD_DIR)/output
